...
#     spx_1min_df = fetch_spx_1min('2025-07-15', '2025-08-15') #range
#     print(spx_1min_df.head())
#     spx_1min_df.to_csv('spx_1min.csv', index=False)
